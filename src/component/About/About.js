  ...
  return (
    <div className="container">
      <section className="team-section text-center" style={{ marginTop: "7%" }}>
        ...
        I am Shams Al Fahad. My Future Goal Is, I Wants To Be A Frontend Developer And In Shaa Allah I Will Fulfill My Goal Soon. I Try To Reach My Goal As Soon As Possible. 🙂
        </p>
